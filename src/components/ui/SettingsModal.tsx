            ...
            {activeTab === 'trading' && (
              <div className="space-y-8 animate-in fade-in duration-200">
                ...
                <section className="space-y-4">
                  <div className="flex items-center gap-2 text-text-tertiary border-b border-border pb-2">
                    <Filter size={14} />
                    <span className="text-[10px] font-bold uppercase tracking-widest">Calendar Filters</span>
                  </div>
                  <div className="grid grid-cols-2 gap-2">
                    {['All', 'Low', 'Medium', 'High'].map(impact => (
                      <button 
                        key={impact}
                        onClick={() => updateSettings({ impactFilter: impact as any })}
                        className={`p-3 border rounded-sm text-xs font-bold uppercase tracking-wider transition-all ${settings.impactFilter === impact ? 'bg-accent/10 border-accent text-accent' : 'bg-background border-border text-text-tertiary hover:border-text-secondary'}`}
                      >
                        {impact} Impact
                      </button>
                    ))}
              ...
              <div className="space-y-8 animate-in fade-in duration-200">
                <section className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <label className="flex items-center justify-between p-3 bg-background border border-border rounded-sm cursor-pointer hover:bg-white/5 transition-colors">
                      <span className="text-xs font-bold text-text-primary uppercase">High Impact Only</span>

...
export function TerminalTutorialModal({
  ...
  return (
    <div className="fixed inset-0 z-[120] bg-black/70 flex items-center justify-center px-3">
      <div className="w-full h-full border border-[#1a1a1a] bg-black flex flex-col min-h-0">
        ...
        <div className="grid grid-cols-[180px_1fr] gap-px bg-[#1a1a1a] min-h-0">
          <div className="bg-[#0a0a0a] min-h-0 overflow-y-auto custom-scrollbar">
            {sections.map((s) => (
              <div key={s} className="px-2 py-[4px] border-b border-[#1a1a1a] text-[9px] text-gray-400">
          ...
          <div className="bg-[#0a0a0a] min-h-0 overflow-y-auto custom-scrollbar text-[9px]">
            ...
            <div className="px-2 py-1 border-t border-[#1a1a1a] text-gray-400">
        ...
        <div className="px-2 border-t border-[#1a1a1a] bg-[#0a0a0a] flex items-center justify-between text-[9px]">
          <span className="text-gray-400">TUTORIAL READY • SIMULATED MARKET MODE</span>

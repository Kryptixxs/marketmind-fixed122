...
export function SystemPulsePanel() {
  ...
  return (
    <section className="bg-black min-h-0 overflow-hidden flex flex-col">
      <div className="h-5 px-1 border-b border-[#1a1a1a] bg-[#0a0a0a] flex items-center justify-between text-[9px]">
      ...
      <div className="grid grid-cols-[34%_33%_33%] gap-px bg-[#1a2433] flex-1 min-h-0">
        ...
        <div className="bg-[#0a0a0a] min-h-0 overflow-y-auto custom-scrollbar">
          ...
          <div className="text-[9px] px-1 py-[2px] border-b border-[#1a1a1a] flex items-center justify-between">
        ...
        <div className="bg-[#0a0a0a] min-h-0 overflow-y-auto custom-scrollbar">
          ...
          {state.alerts.map((a) => (
            <div key={a} className="text-[8px] px-1 py-[1px] border-b border-[#1a1a1a] text-[#d8b4ff]">
              {a}
            </div>
          ))}
        </div>

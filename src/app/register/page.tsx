...
import { Terminal, User, Mail, Lock, Building, ArrowRight, Loader2 } from 'lucide-react';
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input required className="w-full bg-background border border-border rounded-sm pl-9 pr-3 py-3 text-sm text-text-primary focus:border-accent outline-none" placeholder="John" />
              </div>
            </div>
            <div className="space-y-2">
              <label className="text-xs font-bold text-text-tertiary uppercase tracking-wider">Last Name</label>
              <input required className="w-full bg-background border border-border rounded-sm px-4 py-3 text-sm text-text-primary focus:border-accent outline-none" placeholder="Doe" />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input required className="w-full bg-background border border-border rounded-sm pl-10 pr-4 py-3 text-sm text-text-primary focus:border-accent outline-none" placeholder="Prop Shop LLC (Optional)" />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input type="email" required className="w-full bg-background border border-border rounded-sm pl-10 pr-4 py-3 text-sm text-text-primary focus:border-accent outline-none" placeholder="trader@fund.com" />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input type="password" required className="w-full bg-background border border-border rounded-sm pl-10 pr-4 py-3 text-sm text-text-primary focus:border-accent outline-none" placeholder="Create a strong password" />
            </div>
          </div>
